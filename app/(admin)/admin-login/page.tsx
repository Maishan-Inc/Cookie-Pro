    ...
    return (
      <section className="px-6 py-16">
        <div className="mx-auto max-w-3xl rounded-3xl border border-dashed border-rose-200 bg-white p-8 text-center text-sm text-rose-600 shadow-sm dark:border-rose-400/60 dark:bg-rose-950/30 dark:text-rose-100">
          ...
          <p className="mt-2 text-base text-rose-700 dark:text-rose-100">/{settings.admin_path}</p>
    ...
    <section className="px-6 py-16">
      <div className="mx-auto grid max-w-5xl gap-8 lg:grid-cols-2">
        <div className="rounded-3xl border surface-card p-6 shadow-sm text-zinc-900 dark:text-zinc-200">
          ...
          <div className="mt-6 rounded-2xl border surface-muted p-4 text-sm">
        ...
        <div className="rounded-3xl border surface-card p-6 shadow-sm">
          ...
          <form action={loginAction} className="space-y-5">
            ...
            <button
              type="submit"
              className="btn-press w-full rounded-full bg-zinc-900 px-4 py-2.5 text-sm font-semibold text-white transition hover:bg-zinc-800 dark:bg-zinc-700 dark:text-white dark:hover:bg-zinc-600"
            >
              {t.auth.submit}
            </button>
          </form>
